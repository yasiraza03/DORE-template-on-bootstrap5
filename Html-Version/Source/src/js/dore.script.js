    ...
    function init() {
        ...
        $(document).on("click", function (event) {
            if (
                ...
                if (
                    $(event.target).parents("a[data-bs-toggle='collapse']")
                        .length > 0 ||
                    $(event.target).attr("data-bs-toggle") == "collapse"
                ) {
                    return;
                }
        ...
        if (typeof Chart !== "undefined") {
            ...
            Chart.controllers.LineWithShadow = Chart.controllers.line.extend({
                draw: function (ease) {
                    ...
                    ctx.responsive = true;
                    ctx.stroke();
                    Chart.controllers.line.prototype.draw.apply(
                        this,
                        arguments
                    );
                    ctx.restore();
            ...
            Chart.controllers.DoughnutWithShadow =
                Chart.controllers.doughnut.extend({
                    draw: function (ease) {
                        Chart.controllers.doughnut.prototype.draw.call(
                            this,
                            ease
                        );
            ...
            Chart.controllers.ScatterWithShadow =
                Chart.controllers.scatter.extend({
                    draw: function (ease) {
                        Chart.controllers.scatter.prototype.draw.call(
                            this,
                            ease
                        );
                        let ctx = this.chart.chart.ctx;
            ...
            Chart.controllers.RadarWithShadow = Chart.controllers.radar.extend({
                draw: function (ease) {
                    ...
                    ctx.shadowOffsetY = 7;
                    ctx.responsive = true;
                    Chart.controllers.radar.prototype.draw.apply(
                        this,
                        arguments
                    );
                    ctx.restore();
            ...
            Chart.controllers.PolarWithShadow =
                Chart.controllers.polarArea.extend({
                    draw: function (ease) {
                        Chart.controllers.polarArea.prototype.draw.call(
                            this,
                            ease
                        );
                        let ctx = this.chart.chart.ctx;
                ...
                tooltips: {
                    ...
                    custom: function (tooltipModel) {
                        if (tooltipModel && tooltipModel.dataPoints) {
                            var $textContainer = $(
                                this._chart.canvas.offsetParent
                            );
                    ...
                    datasets: [
                        {
                            ...
                            label: "",
                            data: [
                                54, 63, 60, 65, 60, 68, 60, 63, 60, 65, 60, 68,
                            ],
                            borderColor: themeColor1,
                            pointBackgroundColor: foregroundColor,
                            pointBorderColor: themeColor1,
            ...
            if (document.getElementById("contributionChart1")) {
                var contributionChart1 = new Chart(
                    document
                        .getElementById("contributionChart1")
                        .getContext("2d"),
            ...
            if (document.getElementById("contributionChart2")) {
                var contributionChart2 = new Chart(
                    document
                        .getElementById("contributionChart2")
                        .getContext("2d"),
                    contributionChartOptions
                );
            }
            ...
            if (document.getElementById("contributionChart3")) {
                var contributionChart3 = new Chart(
                    document
                        .getElementById("contributionChart3")
                        .getContext("2d"),
                    contributionChartOptions
                );
            }
            ...
            var centerTextPlugin = {
                ...
                beforeDraw: function (chart) {
                    ...
                    if (chart.pointAvailable) {
                        ...
                        activeValue =
                            chart.data.datasets[chart.pointDataIndex].data[
                                chart.pointIndex
                            ];
                        ...
                        activePercentage = chart.legend.legendItems[
                            chart.pointIndex
                        ].hidden
                            ? 0
                            : activePercentage;
        ...
        if ($().DataTable) {
            $(".data-table-standard").DataTable({
                ...
                destroy: true,
                info: false,
                sDom: '<"row view-filter"<"col-sm-12"<"float-left"l><"float-end"f><"clearfix">>>t<"row view-pager"<"col-sm-12"<"text-center"ip>>>',
                pageLength: 6,
                language: {
                    paginate: {
            ...
            $(".data-table-scrollable").DataTable({
                ...
                fnInitComplete: function () {
                    dataTablePs = new PerfectScrollbar(
            ...
            $(".data-table-feature").DataTable({
                sDom: '<"row view-filter"<"col-sm-12"<"float-end"l><"float-left"f><"clearfix">>>t<"row view-pager"<"col-sm-12"<"text-center"ip>>>',
                columns: [
                    { data: "name" },
                    { data: "position" },
                    { data: "office" },
            ...
            $("#pageCountDatatable .dropdown-menu a").on(
                "click",
                function (event) {
            ...
            $("#addToDatatable").on("click", function (event) {
                if ($("#addToDatatableForm").valid()) {
                    ...
                    setTimeout(function () {
                        $addToDatatableButton.showSuccess(
                            true,
                            "New row added!"
                        );
                        setTimeout(function () {
        ...
        if ($().dropzone && !$(".dropzone").hasClass("disabled")) {
            $(".dropzone").dropzone({
                ...
                thumbnailWidth: 160,
                previewTemplate:
                    '<div class="dz-preview dz-file-preview mb-3"><div class="d-flex flex-row "><div class="p-0 w-30 position-relative"><div class="dz-error-mark"><span><i></i></span></div><div class="dz-success-mark"><span><i></i></span></div><div class="preview-container"><img data-dz-thumbnail class="img-thumbnail border-0" /><i class="simple-icon-doc preview-icon" ></i></div></div><div class="ps-3 pt-2 pe-2 pb-1 w-70 dz-details position-relative"><div><span data-dz-name></span></div><div class="text-primary text-extra-small" data-dz-size /><div class="dz-progress"><span class="dz-upload" data-dz-uploadprogress></span></div><div class="dz-error-message"><span data-dz-errormessage></span></div></div></div><a href="#/" class="remove" data-dz-remove><i class="glyph-icon simple-icon-trash"></i></a></div>',
            });
        }
                    ...
                    each(previews, function (elem) {
                        ...
                        if (previewImage) {
                            ...
                            previewImage.style.height =
                                imageData.naturalHeight / imageScaledRatio +
                                "px";
                ...
                if ($(this).parents(".chat-app").length > 0) {
                    ...
                    function calculateHeight() {
                        ...
                        if (window.innerWidth < 576) {
                            ...
                            $(
                                ".chat-app .scroll-content > div:last-of-type"
                            ).css(
                                "padding-bottom",
                                $(".chat-input-container").outerHeight(true) +
                                    "px"
                            );
      ...
      */
        ...
        if ($().smartWizard) {
            ...
            $("#smartWizardCustomButtons .reset-btn").on(
                "click",
                function (event) {
            ...
            $("#smartWizardValidation").on(
                ...
                function (
                    ...
                    if (stepPosition === "first") {
                        $("#smartWizardValidation .prev-btn").addClass(
                            "disabled"
                        );
                        ...
                        $("#smartWizardValidation .prev-btn").removeClass(
                            "disabled"
                        );
                    } else {
                        $("#smartWizardValidation .finish-btn").hide();
            ...
            $("#smartWizardValidation .finish-btn").on(
                "click",
                function (event) {
                    if (
                        checkWizardValidation(
                            $("#smartWizardValidation #form-step-1")
                        )
                    ) {
        ...
        if (typeof Glide !== "undefined") {
            ...
            if ($(".glide.details").length > 0) {
                ...
                glideThumbs.on("resize", function () {
                    perView = Math.min(
                        glideThumbs.settings.perView,
                        glideLength
                    );
                    $(".glide.thumbs").css("width", perView * 70);
                    if (perView >= $(".glide.thumbs li").length) {
                        $(".glide.thumbs .glide__arrows").css(
                            "display",
                            "none"
                        );
                    } else {
                ...
                function (event) {
                    ...
                    $(form)
                        ...
                        .each(function () {
                            ...
                            if (
                                $(this).find(".custom-control input:invalid")
                                    .length ==
