...
(function (h) {
    ...
    h.extend(m.ext.type.detect, [
        ...
        function (a, b) {
            var c = b.oLanguage.sDecimal;
            return Pb(a, c) ? "htms-num" + c : null;
        },
        function (a, b) {
            var c = b.oLanguage.sDecimal;
            return Pb(a, c, !0) ? "htms-num-fmt" + c : null;
        },
        function (a) {
                ...
                if (k)
                    if (d.isArray(k)) this._expandButton(a, k, c, e);
                        ...
                        if (p) {
                            ...
                            k.init &&
                                k.init.call(h.button(p.node), h, d(p.node), k);
                            g++;
                        }
                    }
            }
            ...
            if (
                ...
                (this.c.header &&
                    ((f =
                        !c.visible || a <= c.theadTop - this.c.headerOffset
                            ...
                            ? "in"
                            : "below"),
                    (b || f !== this.s.headerMode) &&
                        this._modeChange(f, "header", b),
                ...
                (a =
                    ...
                    a + c.windowHeight >= c.tfootBottom + this.c.footerOffset
                        ...
                        ? "in"
                        : "above"),
                    (b || a !== this.s.footerMode) &&
                        this._modeChange(a, "footer", b),
...
(function (c) {
    ...
    var e = c.fn.dataTable,
        g = function (a, b) {
            ...
            this.c = c.extend(!0, {}, e.defaults.rowGroup, g.defaults, b);
            this.s = {
                dt: new e.Api(a),
    ...
    c.extend(g.prototype, {
        ...
        _adjustColspan: function () {
            c("tr." + this.c.className, this.s.dt.table().body()).attr(
                "colspan",
                this._colspan()
            );
        },
        ...
        _draw: function () {
            ...
            for (var g = 0, f = c.length; g < f; g++) {
                ...
                this.c.startRender &&
                    ((d = this.c.startRender.call(this, b.rows(h), m)),
                    this._rowWrap(d, this.c.startClassName).insertBefore(
                        l.node()
                    ));
                this.c.endRender &&
                    ((d = this.c.endRender.call(this, b.rows(h), m)),
                    this._rowWrap(d, this.c.endClassName).insertAfter(
                        b.row(h[h.length - 1]).node()
                    ));
            }
        },
