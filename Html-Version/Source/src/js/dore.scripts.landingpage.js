    ...
    function init() {
        ...
        if ($().owlCarousel) {
            ...
            $(".owl-dot").click(function () {
                ...
                carouselReference.trigger("to.owl.carousel", [
                    $(this).index(),
                    300,
                ]);
            });
        ...
        $(".landing-page").on("click", function (event) {
            if (
                !(
                    $(event.target).parents().hasClass("mobile-menu-button") ||
        ...
        $(".scrollTo").on("click", function (event) {
            ...
            $(window).scrollTo(target, 500, {
                ...
                onAfter: function () {
                    ...
                    if (target != "#home") {
                        setTimeout(function () {
                            $(".landing-page-nav").removeClass(
                                "headroom--pinned"
                            );
                            $(".landing-page-nav").addClass(
                                "headroom--unpinned"
                            );
                        }, 60);
                    }
        ...
        function onResizeLandingPage() {
            ...
            if ($(".footer-row").length > 0) {
                ...
                $(".landing-page .section.footer").css(
                    "background-position-x",
                    Math.min($(window).width() - rowOffestFooter - 2000, 0) +
                        "px"
                );
            }
